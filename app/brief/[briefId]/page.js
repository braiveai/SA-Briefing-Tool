                      ...
                      <div className="border-t border-gray-700 p-4 bg-sunny-dark/50 animate-fade-in">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          <div>
                            ...
                            <div className="space-y-2 text-sm">
                              ...
                              {item.specs?.dayPart && (
                                <div className="flex justify-between">
                                  <span className="text-gray-400">Daypart</span>
                                  <span>{item.specs.dayPart}</span>
                                </div>
                              )}
                              {item.specs?.spotCount && (
                                <div className="flex justify-between">
                                  <span className="text-gray-400">Spots</span>
                                  <span>{item.specs.spotCount}</span>
                                </div>
                              )}
                            </div>
                          </div>
                          <div>
                            ...
                            <div className="space-y-2 text-sm">
                              ...
                              {item.flightStart && (
                                <div className="flex justify-between">
                                  <span className="text-gray-400">Flight Dates</span>
                                  <span>{item.flightStart} → {item.flightEnd}</span>
                                </div>
                              )}
                              <div className="flex justify-between">
                        ...
                        {item.restrictions && item.restrictions.length > 0 && (
                          <div className="mb-4 p-3 bg-red-900/20 border border-red-700/30 rounded-lg">
                            <div className="text-xs font-medium text-red-400 uppercase mb-1">⚠️ Content Restrictions</div>
