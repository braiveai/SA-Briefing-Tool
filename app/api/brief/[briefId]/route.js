                    ...
                    {isEditing ? (
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button onClick={(e) => { e.stopPropagation(); startEdit(p); }}
                          className="text-xs text-white/30 hover:text-sunny-yellow p-1 rounded hover:bg-white/10 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity"
