...
export const CHANNELS = [
  ...
  { id: 'programmatic', name: 'Programmatic', icon: '🎯' },
];

// Default lead times per publisher (business days before flight start)
// These can be overridden per-brief
